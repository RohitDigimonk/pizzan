...
import {View,Text, StyleSheet,TouchableWithoutFeedback,ImageBackground,ScrollView,TouchableOpacity,LayoutAnimation,SafeAreaView,Image} from 'react-native';
...
class Tilbodoffer extends Component{

    state = {half:'first',allpizza:[],toppingdata:[], indicator:0,offerDetails:'',type:'',half:'first',
    ...
    checktopping = (i,toppingname,toppingprice,indicator)=>{
        ...
        // console.log(firstprice,secondprice,'asdf')
    ...
    addtocart=()=>{
        ...
        var paidtoppings = newarray.slice(this.offerdata.offerDetails[0].toppingCount);
        var paidtoppingstotal = paidtoppings.reduce((prev,next) => prev + next.price,0)
        ...
        const selectedpizza = this.offerdata
         ...
         const price = selectedpizza.minimumPrice+paidtoppingstotal
        ...
        const keyValue = []
        const addpizza = {bottom:bottom,secondfreepizza:false,halftoppingone:halftoppingone, ownpizza:ownpizza,name:pizzaname,
    ...
    render(){
        // console.log(this.offerdata.offerDetails[0].toppingCount)
...
export default connect(mapStateToProps,mapDispatchToProps)(Tilbodoffer);
