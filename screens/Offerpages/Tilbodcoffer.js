...
class Tilbodcoffer extends Component{
...
//    price = parseInt(this.props.navigation.state.params.price)
    ...
    addtocart=()=>{
        ...
        this.state.checkedDefault.map(data=>{
            ...
            const toppingname = this.state.toppingname
            const addpizza = {secondfreepizza:true,ownpizza:ownpizza,name:ownselectedpizza,selectedsides:sidesname,halftoppingone:halftoppingone,
    ...
    render(){
        ...
        const { split,checkedDefault,secondcheckedDefault,selectedpizza,indicator,selectoption,selectedsides,half } = this.state;
        return(
...
export default connect(mapStateToProps,mapDispatchToProps)(Tilbodcoffer);